...
# ╔═╡ 0f894d16-942b-11ed-2930-8942ecbeab1d
begin
	using CSV,DataFrames,TypedTables,Plots,GLM,StatsPlots,CategoricalArrays,Interact
	cars=DataFrame(CSV.File("data/CAR DETAILS FROM CAR DEKHO.csv"));describe(cars)
end

# ╔═╡ c238603f-6019-4515-a000-ba3f5a7b2f33
begin
	X=round.(Int,cars.km_driven/1000);Y=round.(Int,cars.selling_price/1000);years_and_km_driven=@df cars scatter(X,Y,ms=5,ma=0.5,lw=1,tittle="Car selling price - Ankur Satyarthi",xlabel="KM DRIVEN",ylabel="PRICE(In thousands of rupees, ref: CarDekho",legend=false,color=:skyblue)
end

# ╔═╡ e7b4cded-e7c5-4474-8aec-3077905ce442
t=Table(X=X,Y=Y)

# ╔═╡ 129e8922-f054-406d-a8b9-286b904fa351
gr(size=(600,600));plot_scatter=scatter(X,Y,ma=0.5,ms=5,xlims=(0,850),ylims=(0,8999),xlabel="KM DRIVEN(In thousands)",ylabel="PRICE(In thousands of rupees, ref: CarDekho)",title="Car selling prices - Ankur Satyarthi",legend=false,color=:teal)

# ╔═╡ 5939b946-dd25-48c5-872f-17268f167c36
ols=lm(@formula(Y~X),t)

# ╔═╡ 64ad961c-e22b-4819-8836-fe853999ac70
plot!(X,predict(ols),color=:red,linewidth=1)

# ╔═╡ e9fc3bb9-3f57-4f1c-ab1c-c7e43454b77c
new_X=Table(X=[123]);predict(ols,new_X)

# ╔═╡ 182961f8-611a-414e-b4ae-048b068e2985
begin
	epochs = 0;
	plot_scatter1 = scatter(X, Y,
		xlims = (0, 810),
		ylims = (0, 8900),
...
# ╔═╡ da7c1e8d-5cef-47f9-9609-08abd8fe325e
plot!(X,y_hat,color=:red,alpha=0.5,
	    title="Car Selling Prices (epochs = $epochs)")

# ╔═╡ 3c09a951-6c0f-4552-870a-b78c9ac9aae4
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "7b4daa1e3672992174fcaa9764d0d0e845f8bf29"
